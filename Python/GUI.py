...
def main():
    ...
    text1 = Tk.Label(root, text= stupidSpaceConstant + "Take Picture >", font=("Helvetica", 35, "bold"), fg='orange', bg = 'blue')
    text1.grid(row = 1, column = 2)

    text2 = Tk.Label(root, text= stupidSpaceConstant + "      Continue >", font=("Helvetica", 35, "bold"), fg='orange', bg = 'blue')
